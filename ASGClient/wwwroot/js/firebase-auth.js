...
const firebaseConfig = {
    apiKey: "AIzaSyCnuS0rz6e803fstx9p6t1q8sz0Ce0DdE4",
    authDomain: "anythingsoundsgood-56993.firebaseapp.com",
    projectId: "anythingsoundsgood-56993",
    storageBucket: "anythingsoundsgood-56993.appspot.com",
    messagingSenderId: "951457583579",
    appId: "1:951457583579:web:2d2ea5095d6469c65a97fe",
    measurementId: "G-H0XR842VEF"
};
            ...
            try {
                ...
                if (!window.firebaseAuth.isTokenValid(tokenResult.expirationTime)) {
                    ...
                    if (refreshedToken) {
                        ...
                        localStorage.setItem('ASGUser', JSON.stringify(user)); // Update localStorage
                    } else {
...
window.addEventListener('load', () => {
    ...
    onAuthStateChanged(auth, async (user) => {
        if (user) {
            const storedUser = localStorage.getItem('ASGUser');
